    ...
    <section className="pf-workspace-panel p-5 sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          ...
          <h2 className="mt-1 text-xl font-bold tracking-tight text-[var(--pf-black)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="rounded-full bg-[var(--pf-black)] px-2.5 py-1 text-xs font-bold text-white">
            {tierLabel}
          </span>
          {billingInterval === "annual" ? (
            <span className="rounded-full border border-[var(--pf-border)] bg-white px-2.5 py-1 text-xs font-semibold text-[var(--pf-gray-700)]">
              Annual
            </span>
          ) : null}
          <span
      ...
      <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 border-t border-[var(--pf-border)] pt-4 text-xs font-semibold">
        ...
        {membershipTier === "member" && subscriptionStatus === "active" ? (
          <span className="text-[var(--pf-gray-500)]">
            Pro from {formatTierPriceLong("pro")} — upgrade in Plan & billing
          </span>
        ) : null}
      </div>
    </section>
