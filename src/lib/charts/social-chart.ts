...
const HEADER_H = 196;
const FOOTER = SOCIAL_CHART_BOTTOM_PAD + 48;
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  ${date ? txt(PAD, y + 62, `Called ${date}`, { size: 13, weight: 500, fill: C.textDim }) : ""}
  ...
  ${txt(PAD, footerTop + 30, "Not investment advice  ·  portfuel.pro", { size: 10, weight: 500, fill: C.textDim })}
</svg>`;
}
