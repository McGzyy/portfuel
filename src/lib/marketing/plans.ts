...
export const TIER_COMPARISON_ROWS: TierComparisonRow[] = [
  ...
  { feature: "Book analytics (target hits, streaks, 30d win rate)", member: false, pro: true },
...
export const PRO_VALUE_BULLETS = [
  ...
  "Book analytics — target hit rate, win streaks, 30d win rate, avg hold on closed calls",
