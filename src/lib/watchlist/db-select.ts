...
/** When position_intent and/or price_alert_pct columns are missing but journal columns exist. */
...
export const JOURNAL_FULL_SELECT =
  "symbol, asset_class, created_at, baseline_price, thesis, conviction, entry_price, stop_price, target_price, entry_note, journal_updated_at, catalysts, risk_factors, research_followups, personal_tags, outcome, position_intent, bull_case_price, base_case_price, bear_case_price";
